...
/* ------------------------------ Registry item ----------------------------- */
export const leverage: OnePager = {
  key: "leverage",
  question: "Which leverage should we use to multiply output?",
  hook: "Stack Media, Code, People, and Capital to compound results without compounding effort.",
  summary:
    "A practical framework to choose and sequence leverage—what to look for, 80/20 plays, KPIs, risks, and a 14-day sprint template.",
  bullets: [
    "Clear decision rules for next best lever",
    "Expanded plays and KPI floors per lever",
    "Fill-in Leverage Map and example stack",
  ],
  steps: [
    { t: "Media", d: "Prove and package value; build proof" },
    { t: "Code", d: "Automate obvious work; add alerts" },
    { t: "People", d: "Delegate to specialists; SOPs" },
    { t: "Capital", d: "Amplify winners; buy speed" },
  ],
  kpis: ["Content-assist %", "Hours saved/seat", "SLA hit %", "Payback window"],
  tools: ["Zapier/Make", "CRM", "Editors", "Ad Platforms", "Analytics"],
  cta: "Open the page, pick a primary + secondary lever, and run the 14-day sprint.",
  category: "Strategy & Ops",
  render: () => <LeverageOnePager />,
};
