...
const STAGES: Stage[] = [
  {
    ...
    modules: [
      { title: "Monk Mode", slug: "monk-mode" },
      { title: "Focus", slug: "distraction-less" },            
      { title: "Routine", slug: "routine" },                                      
      { title: "Mental Energy", slug: "mental-energy" },                  
      { title: "Limiting Beliefs", slug: "belief-reframes" },
      { title: "Kaizen & Iteration Cycles", slug: "kaizen" },                       
      { title: "Learning Techniques", slug: "meta-learning" },
      { title: "Mastery Checklist", slug: "mastery-checklist" },
      { title: "The Scientific Method", slug: "scientific-method" },  
      { title: "Long-Term Perspective", slug: "long-term-stance" },
    ],
    focus:
  ...
  },
  {
    ...
    modules: [
      { title: "Market Research System", slug: "market-research-system" },
      { title: "Ideal Avatar Analysis", slug: "ideal-avatar-bm" },
      ...
      { title: "Ethical Lead Scraping", slug: "lead-scraping-playbook" },
    ],
    focus:
  ...
  },
  {
    ...
    modules: [
      ...
      { title: "50+ Offer Formats", slug: "offer-format-library" },
      { title: "Value Ladder Framework", slug: "value-ladder" },
      { title: "Pricing Scripts & Anchoring", slug: "pricing-anchors" },
      { title: "Productizing a Skill into a Service", slug: "productize-skill" },
      { title: "Skill to Profit Gameplan", slug: "skill-to-profit" },
