...
const STAGES: Stage[] = [
  {
    ...
    modules: [
      ...
      { title: "Distraction-less = Focused", slug: "distraction-less" },            
      { title: "Routine", slug: "routine" },                                      
      { title: "Mental Energy Systems", slug: "mental-energy" },                  
      ...
      { title: "The Scientific Method (for builders)", slug: "scientific-method" },  
